...
export const createDivider = (): MenuItemType => ({
  type: 'divider',
});
...
export const MenuItems = {
  // 用户相关
  privateMessage: (onClick: () => void) => createMenuItem('privateMessage', '私信', 'Message', onClick),
  mention: (onClick: () => void) => createMenuItem('mention', '艾特', 'At', onClick),
  addFriend: (onClick: () => void) => createMenuItem('addFriend', '添加好友', 'AddFriend', onClick),
  viewProfile: (onClick: () => void) => createMenuItem('viewProfile', '查看资料', 'Profile', onClick),
  
  // 设置相关
  profilePage: (onClick: () => void) => createMenuItem('profilePage', '个人主页', 'Profile', onClick),
